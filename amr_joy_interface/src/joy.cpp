...
Joy::Joy() {
  ...
  pnh.param("max_roll", max_.roll, 15.0 * M_PI / 180.0);  // [rad]
  pnh.param("max_pitch", max_.pitch, 15.0 * M_PI / 180.0);  // [rad]
  pnh.param("max_yawrate", max_.yawrate, 180.0 * M_PI / 180.0);  // [rad/s]
